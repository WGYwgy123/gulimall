package com.wgy.gulimall.product.entity;
...
import com.wgy.common.validate.AddGroup;
import com.wgy.common.validate.ListValue;
import com.wgy.common.validate.UpdateGroup;
import com.wgy.common.validate.UpdateStatusGroup;
import lombok.Data;
...
public class BrandEntity implements Serializable {
	 ...
	 * 品牌logo地址
	 */
	@NotEmpty(message = "logo地址必须提交", groups = {AddGroup.class})
